...
CREATE EXTENSION unaccent; -- Remove acentuação usando a função unaccent('Júnior')
...
-- INSERT INTO customer VALUES (DEFAULT, 'Janilson Júnior', '09876543210', TO_DATE('14/11/1998', 'DD/MM/YYYY'), 'janilsonej@hotmail.com', '123@456', '+5562987654321', true);
-- INSERT INTO customer_address VALUES (DEFAULT, 1, '98765432', 'Rua Tubal da Silva Brandão', '926', 'Bancários', 'João Pessoa', 'PB');
-- INSERT INTO customer_card VALUES (DEFAULT, 1, '5203 1311 2113 6896', 'Janilson Júnior', TO_DATE('07/24', 'MM/YY'), '759');
